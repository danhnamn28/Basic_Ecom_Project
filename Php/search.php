...
//     // Lấy từ khóa tìm kiếm từ dữ liệu GET
//     $search_query = $_GET['timkiem'];

//     // Thực hiện truy vấn SQL để tìm kiếm sản phẩm
//     $query = "SELECT * FROM sanpham WHERE ten_sp LIKE '%$search_query%'";
...
//         }
    // } else {
    //     // Nếu không có kết quả tìm kiếm, hiển thị thông báo không tìm thấy
                    ...
                    <div class="grid__collumn-2">
                        <nav class="category">
                            <h3 class="category__heading">
                                ...
                                The product you searched for                            </h3>
